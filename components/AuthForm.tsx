      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
              {type === 'sign-up' && (
                <>
                  ...
                  <CustomInput 
                    control={form.control} name='address1' label="Adress" placeholder='Enter your specific adress'
                  />
                  <CustomInput 
                  ...
                  <div className='flex gap-4'>
                    ...
                    />
                    <CustomInput 
                      control={form.control} name='postalCode' label="Postal Code" placeholder='Example 22-90100'
                    />
                  </div>
                  <div className='flex gap-4'>
                    <CustomInput 
